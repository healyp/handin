...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.generate_csv_button = QtWidgets.QPushButton(Dialog)
        self.generate_csv_button.setGeometry(QtCore.QRect(420, 10, 160, 22))
        self.generate_csv_button.setObjectName("generate_csv_button")
        self.checkBox_all_csv = QtWidgets.QCheckBox(Dialog)
        self.checkBox_all_csv.setGeometry(QtCore.QRect(600, 10, 80, 22))
        self.checkBox_all_csv.setObjectName("checkBox_all_csv")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.generate_csv_button.setText(_translate("Dialog", "Generate CSV"))
        self.generate_csv_button.setToolTip("Generate grade reports in CSV on the file server")
        self.checkBox_all_csv.setText(_translate("Dialog", "All"))
        self.checkBox_all_csv.setToolTip("Generate CSV reports for all available assignments")
