...
def check_if_module_exists(module_code: str, ay: str) -> bool:
    path = modulePath(module_code: str, ay: str)
...
def check_if_ass_exists(module_code: str, ay: str, ass: str) -> bool:
    path = assPath(module_code: str, ay: str, ass: str)
    if os.path.exists(path):
        return True
    return False
